...
from . import gs_camera as util
from . import gs_util as util_gau
import numpy as np
import os
...
# Get the directory of this module for shader paths
...
class OpenGLRenderer(GaussianRenderBase):
    def __init__(self, w, h):
        ...
        vert_shader = os.path.join(_module_dir, 'shaders', 'gau_vert.glsl')
        frag_shader = os.path.join(_module_dir, 'shaders', 'gau_frag.glsl')
        self.program = util.load_shaders(vert_shader, frag_shader)
