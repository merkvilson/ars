...
# Camera FOV Commands
BBL_cam_fow_add_CONFIG = {"symbol": ic.ICON_EYE_PLUS, "hotkey": "Shift+mouse-wheel-down", "visible": False}
def BBL_cam_fow_add(*args):
    cam_fow_add(ars_window())

BBL_cam_fow_sub_CONFIG = {"symbol": ic.ICON_EYE_MINUS, "hotkey": "Shift+mouse-wheel-up", "visible": False}
def BBL_cam_fow_sub(*args):
    cam_fow_sub(ars_window())

# Camera Speed Commands
BBL_cam_speed_up_CONFIG = {"symbol": ic.ICON_SPEED_UP, "hotkey": "Ctrl+mouse-wheel-up", "visible": False}
def BBL_cam_speed_up(*args):
    cam_speed_up(ars_window())

BBL_cam_speed_down_CONFIG = {"symbol": ic.ICON_SPEED_DOWN, "hotkey": "Ctrl+mouse-wheel-down", "visible": False}
def BBL_cam_speed_down(*args):
    cam_speed_down(ars_window())

# Camera Move Commands
BBL_cam_move_in_CONFIG = {"symbol": ic.ICON_ZOOM_IN, "hotkey": "Alt+mouse-wheel-up", "visible": False}
def BBL_cam_move_in(*args):
    cam_move_in(ars_window())

BBL_cam_move_out_CONFIG = {"symbol": ic.ICON_ZOOM_OUT, "hotkey": "Alt+mouse-wheel-down", "visible": False}
def BBL_cam_move_out(*args):
    cam_move_out(ars_window())


BBL_tst_CONFIG = {"symbol": None, "hotkey": "#", "visible": False}
def BBL_tst(*args):
    print("Test")
