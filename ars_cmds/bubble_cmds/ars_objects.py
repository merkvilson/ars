...
def execute_plugin(ars_window):
    ...
    config.callbackL = {
        ...
        ic.ICON_OBJ_BOX:           lambda: add_primitive(primitive_type='cube', animated=True         ),
        ic.ICON_OBJ_SPHERE:        lambda: add_primitive(primitive_type='sphere', animated=True       ),
        ic.ICON_OBJ_CYLINDER:      lambda: add_primitive(primitive_type='cylinder', animated=True     ),
        ic.ICON_OBJ_CONE:          lambda: add_primitive(primitive_type='cone', animated=True         ),
